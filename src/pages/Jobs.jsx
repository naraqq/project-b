                ...
                {data?.length > 0 ? (
                  data?.map((job, index) => {
                    return (
                      <div
                        key={index}
                        className="nunito-400 shadow-sm flex flex-col gap-2 text-gray-600 w-full md:w-full text-sm p-3 rounded bg-[#F9F9F9]"
                      >
                        <div>
                          <img
                        ...
                        <button
                          ...
                          className="border border-gray-500 mt-auto rounded p-2 w-full hover:shadow"
                        >
                          Анкет илгээх
                        </button>
                      </div>
