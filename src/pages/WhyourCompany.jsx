      ...
      {loading ? (
        ...
        <div className="h-full relative bg-white">
          ...
          <div className="body">
            <div className="main">
              <h1
                className=" w-full pb-2 border-gray-600 pt-5 pl-3 text-[20px]  text-start uppercase
       nunito-500 text-gray-500
        "
              >
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 px-3 pb-10 border-b">
                {data?.map((job, index) => {
                  return (
                    ...
                    >
                      <div className="px-2 nunito-400">{job.jobTitle}</div>
              ...
              {/* <div className="w-full p-3">
                <div className="w-full bg-[#F9F9F9] rounded p-3 nunito-400 text-gray-600 text-sm ">
                  ...
                  <div
                    ...
                    className="mt-2 rounded bg-gray-100 hover:shadow text-gray-600 w-fit nunito-400 text-sm p-2 select-none cursor-pointer"
                  >
                    Анкет илгээх
                  </div>
                </div>
