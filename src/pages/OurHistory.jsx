                  ...
                  {selected === 0 && (
                    <div className="nunito-300 text-[14px] flex flex-col md:flex-row gap-4">
                      <LazyLoadImage
                        ...
                        alt="Image Alt"
                      />
                      <p className="nunito-300 text-[14px]">
                        Инсталл наран констракшн ХХК нь барилга бүтээн
                        байгуулалтын болон үл хөдлөх хөрөнгийн салбарт 2009
                        оноос эхлэн өнөөдрийг хүртэл амжилттай ажиллаж ирсэн.
                        ...
                        байгуулалтын салбарт болон 2022 онд Инсталл Наран
                        Конкрит ХХК-ийг үүсгэн байгуулж, Бетон зуурмагийн
                        үйлдвэрлэлийн салбарт төрөлжсөн бүх төрлийн үйлчилгээг
                        эрхэлж, салбартаа тэргүүлэгч байгууллага болохоор
                        зорилго тавин ажиллаж байна. Мөн байгууллагынхаа
                        өрсөлдөхүйц чанарыг бэхжүүлэх үүднээс олон улсын орчин
                        үеийн компанийн засаглал болон удирдлагын тогтолцоог
                        өөрийн соёл, онцлогт тохируулан нэвтрүүлж
                        харилцагчдынхаа 100%-ийн сэтгэл ханамж болон давтан
                        бизнесийн төлөө сэтгэл зүрх нэгдсэн хамт олон
                        хөдөлмөрлөж байна. Их бүтээн байгуулалтын зүг харилцагч
                        та бүхэнтэйгээ хамтдаа тэмүүлцгээе. <br />
