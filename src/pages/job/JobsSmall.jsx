...
function JobsSmall() {
  ...
  return (
    <div>
      {loading ? (
        <div className="body">
          <div className="main  pt-3 flex justify-center items-center ">
        ...
        <div className="h-full relative bg-white">
          ...
          <div className="body ">
            <div className="main about-us  ">
              <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 px-3 pb-10 border-b ">
                {data?.length > 0 ? (
                  data?.map((job, index) => {
                    return (
                      <div
                        key={index}
                        className="nunito-400 shadow-sm flex flex-col justify-between gap-2 text-gray-600 w-full md:w-full text-sm p-3 rounded bg-[#F9F9F9]"
                      >
                        <div className="flex flex-col justify-between h-full">
                          <div className="">
                            ...
                            />
                            <div className="px-2 nunito-400 mt-2 !font-[500] text-[17px] mb-2">
                              {job.jobTitle}
                            </div>
                          ...
                          <div className="mt-auto ">
                            <div className="mt-2">
                              {job.jobRequirement.map((item, ind) => {
                                return (
                                  <p
                                    className="p-2 mb-1 bg-sky-100 text-sky-700 rounded nunito-400"
                                    key={ind}
                                  >
                                    {item}
                                  </p>
                            ...
                            <div className="w-full flex flex-col items-center mt-2 justify-start">
                        ...
                        <button
                          ...
                          className="border border-gray-500 p-2 w-full hover:shadow"
                        >
                          Анкет илгээх
                        </button>
                      </div>
