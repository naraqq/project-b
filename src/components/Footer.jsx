        ...
        <div className="container w-11/12 md:w-9/12 flex justify-center">
          <div className="row">
            <div className="col-sm-12 col-md-6">
              <h6 className="nunito-300">Хамтарч ажиллах</h6>
              <p className="text-justify nunito-300">
                Бид эрхэм захиалагч таньтай Хамтарч ажиллахад үргэлж бэлэн байх
                болно. Бид эрхэм захиалагч таньтай Хамтарч ажиллахад үргэлж
                бэлэн байх болно. Бид эрхэм захиалагч таньтай Хамтарч ажиллахад
                үргэлж бэлэн байх болно.
              </p>
            </div>
